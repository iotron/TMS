...
return [
    ...
    */
    ...
    //'media_action' => \App\Helpers\TipTapMedia\TipTapEditorMediaAction::class,
    //'media_action' => config('tiptap-spatie-media.action'),
    ...
    */
    ...
    'floating_menu_tools' => ['media', 'grid-builder', 'details', 'table', 'oembed'],
